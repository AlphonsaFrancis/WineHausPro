  ...
  return (
    <div>
      ...
      <ToastContainer 
        ...
        draggable
        pauseOnHover
      /> {/* Add ToastContainer for the toast messages */}
      <div className="cart-page">
        <h1>Your Shopping Cart</h1>
        ...
        <div className="cart-container">
          <div className="cart-items">
            {cartItems.length > 0 ? (
              ...
              <p style={{ color: 'red', textAlign: 'center', paddingTop: '100px', fontWeight: 'bold' }}>
                Your cart is empty
              </p>
            )}
          </div>

          {cartItems.length > 0 && ( // Only display if there are items in the cart
            <div className="cart-summary">
              <h3 className="summary-title">Order Summary</h3>
              <p className="summary-item">Subtotal: <span className="summary-amount">₹ {total - 100}</span></p>
              <p className="summary-item">Shipping: <span className="summary-amount">₹ 100</span></p>
